			...
			$("#map_extended").gMap({
				markers: [{
					...
					html: '<h4>Office</h4>' +
						...
						'<div>' +
						'<div><b>Address:</b></div>' +
						'<div>House-13,Road-10, Lane-5<br>Block-C, Mirpur-11<br>Dhaka, Bangladesh</div>' +
						'</div>' +
						'<div>' +
						'<div><b>Phone:</b></div>' +
						'<div>+88 01915561986</div>' +
						'</div>' +
						'<div>' +
						'</div>' +
						'<div>' +
						'<div><b>Email:</b></div>' +
						'<div><a href="mailto:jobayercse@gmail.com">jobayercse@gmail.com</a></div>' +
						'</div>' +
						'</address>',
					latitude: 23.815735,
					longitude: 90.3707934,
					icon: {
